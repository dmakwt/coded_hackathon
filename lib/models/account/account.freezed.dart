...
mixin _$Account {
  ...
  double get onHoldBalance => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      name: name == freezed
          ...
          : name // ignore: cast_nullable_to_non_nullable
              as String,
      onHoldBalance: onHoldBalance == freezed
...
class _$_Account implements _Account {
  ...
  @override
  String toString() {
    return 'Account(id: $id, balance: $balance, email: $email, name: $name, onHoldBalance: $onHoldBalance, createdAt: $createdAt)';
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.onHoldBalance, onHoldBalance) &&
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(onHoldBalance),
...
abstract class _Account implements Account {
  const factory _Account(
      ...
      final String name,
      required final double onHoldBalance,
